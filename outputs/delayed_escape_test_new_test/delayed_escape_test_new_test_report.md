# delayed_escape_test_new_test — Simulation Report

Config file: `config/delayed_escape_test_updated.yaml`
Archive file: `outputs/delayed_escape_test_new_test/delayed_escape_test_new_test.bin`

## Simulation
- Name: delayed_escape_test_new_test
...
time_step=5
[195. 200.]
Saving SimulationArchive to: outputs/delayed_escape_test_new_test/delayed_escape_test_new_test.bin
...
Saved archive: outputs/delayed_escape_test_new_test/delayed_escape_test_new_test.bin
...
Saved: outputs/delayed_escape_test_new_test/figures/survival_fraction_vs_time.png
Saved: outputs/delayed_escape_test_new_test/figures/mean_semimajor_axis_vs_time.png
Saved: outputs/delayed_escape_test_new_test/figures/mean_eccentricity_vs_time.png
Saved: outputs/delayed_escape_test_new_test/figures/rms_eccentricity_vs_time.png
Saved: outputs/delayed_escape_test_new_test/figures/rms_inclination_vs_time.png
Saved: outputs/delayed_escape_test_new_test/figures/a_vs_e_initial_final.png
Saved: outputs/delayed_escape_test_new_test/figures/a_vs_i_initial_final.png
Inner plotted edge = 32.90 AU
Outer plotted edge = 48.83 AU
Saved: outputs/delayed_escape_test_new_test/figures/xy_initial_final.png
