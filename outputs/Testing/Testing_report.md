# Testing — Simulation Report

Config file: `config/Testing.yaml`
Archive file: `outputs/Testing/Testing.bin`
...
```
Saving SimulationArchive to: outputs/Testing/Testing.bin
...
Saved archive: outputs/Testing/Testing.bin
Number of snapshots saved: 4
...
Saved: outputs/Testing/figures/survival_fraction_vs_time.png
Saved: outputs/Testing/figures/mean_semimajor_axis_vs_time.png
Saved: outputs/Testing/figures/mean_eccentricity_vs_time.png
Saved: outputs/Testing/figures/rms_eccentricity_vs_time.png
Saved: outputs/Testing/figures/rms_inclination_vs_time.png
Saved: outputs/Testing/figures/a_vs_e_initial_final.png
Saved: outputs/Testing/figures/a_vs_i_initial_final.png
Inner plotted edge = 32.90 AU
Outer plotted edge = 48.83 AU
Saved: outputs/Testing/figures/xy_initial_final.png
