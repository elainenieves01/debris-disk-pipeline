...
6. Produce initial, final, and survival-time dynamical maps.

Important scientific note
-------------------------
The orbital elements plotted here are osculating elements or time-averaged
osculating elements. They are NOT proper elements. Proper elements require
additional filtering/frequency analysis and are not computed by this script.
"""
